...
agg_target1_windows1 <- create_features_on_period(data, "2011-05-01", "2011-05-30", c(1))
...
agg <- create_features(from = as.Date("2010/03/01"), to = as.Date("2011/04/01"), by = "month")
